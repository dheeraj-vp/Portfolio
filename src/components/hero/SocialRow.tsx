...
import { SPRING_SNAPPY, HERO_DELAYS } from '../../lib/animation';
import { useReducedMotion } from '../../hooks/useReducedMotion';
import type { Social } from '../../data/profile';

// Custom SVG icons — no heavy icon libraries for social
function GitHubIcon() {
  return (
    ...
    >
      {socials.map((social, i) => (
        <motion.div
          ...
          transition={{
            ...SPRING_SNAPPY,
            delay: HERO_DELAYS.socialBase + i * HERO_DELAYS.socialStagger,
          }}
          className="relative"
          role="listitem"
        >
          <motion.a
            ...
            style={{
              color: hovered === social.id ? '#A1A1AA' : '#71717A',
              textDecoration: 'none',
            }}
          >
