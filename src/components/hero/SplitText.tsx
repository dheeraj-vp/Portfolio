...
// Augment HTMLElement to carry the revert reference
declare global {
...
export function SplitText({
  ...
  const Tag = (tag || 'p') as ValidTag;
  return (
    <Tag
      // @ts-expect-error — ref type mismatch between generic HTMLElement and specific element
      ref={ref}
